...
public class IPUtil {
	...
	public static long toNumber(String ip){
		...
		for (int i = 0; i < arr.length; i++) {
			result += ((Integer.parseInt(arr[i])&0xFFL)<<(i*8));
		}
		return result;
	}
	...
	public static String toString(String num){
		if(!num.contains("."))
			return num;
		return toString(Long.valueOf(num));
	}
	
	public static String toString(long num){
		String l1 = String.valueOf(num&0xFF);
		String l2 = String.valueOf((num>>8)&0xFF);
		String l3 = String.valueOf((num>>16)&0xFF);
		String l4 = String.valueOf((num>>24)&0xFF);
		return l1+"."+l2+"."+l3+"."+l4;
	}
