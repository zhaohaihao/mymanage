...
<@dcList "${siteUrl}/datacenter/retainList" 0 1800>
<style>
.other-tables{
	float:left;
...
<div class="widget-content" style="overflow:auto;">
	...
	<#list page.items as item>
		<tr>
			...
			<td>${item.dayAdduser?default(0)}</td>
			<td class="col_a">${item.days1Login?default(0)}</td>
			<td class="col_b">#{item.day1Rate*100 ;m0M4}%</td>
			<td class="col_a">${item.days2Login?default(0)}</td>
			<td class="col_b">#{item.day2Rate*100 ;m0M4}%</td>
			<td class="col_a">${item.days3Login?default(0)}</td>
			<td class="col_b">#{item.day3Rate*100 ;m0M4}%</td>
			<td class="col_a">${item.days4Login?default(0)}</td>
			<td class="col_b">#{item.day4Rate*100 ;m0M4}%</td>
			<td class="col_a">${item.days5Login?default(0)}</td>
			<td class="col_b">#{item.day5Rate*100 ;m0M4}%</td>
			<td class="col_a">${item.days6Login?default(0)}</td>
			<td class="col_b">#{item.day6Rate*100 ;m0M4}%</td>
			<td class="col_a">${item.days7Login?default(0)}</td>
			<td class="col_b">#{item.day7Rate*100 ;m0M4}%</td>
			<td class="col_a">${item.days15Login?default(0)}</td>
			<td class="col_b">#{item.day15Rate*100 ;m0M4}%</td>
			<td class="col_a">${item.days30Login?default(0)}</td>
		    ...
		    series : [
		        {
		            ...
		            data:[<#list page.items?reverse as item>'${item.days1Login?default(0)}'<#if item_index lt page.showCount-1>,</#if></#list>]
		        },
		        {
		            name:'2日留存数',
		            type:'line',
		            ...
		            data:[<#list page.items?reverse as item>'${item.days2Login?default(0)}'<#if item_index lt page.showCount-1>,</#if></#list>]
		        },
		        {
		            name:'3日留存数',
		            type:'line',
		            ...
		            data:[<#list page.items?reverse as item>'${item.days3Login?default(0)}'<#if item_index lt page.showCount-1>,</#if></#list>]
		        },
		        {
		            name:'4日留存数',
		            type:'line',
		            ...
		            data:[<#list page.items?reverse as item>'${item.days4Login?default(0)}'<#if item_index lt page.showCount-1>,</#if></#list>]
		        },
		        {
		            name:'5日留存数',
		            type:'line',
		            ...
		            data:[<#list page.items?reverse as item>'${item.days5Login?default(0)}'<#if item_index lt page.showCount-1>,</#if></#list>]
		        },
		        {
		            name:'6日留存数',
		            type:'line',
		            ...
		            data:[<#list page.items?reverse as item>'${item.days6Login?default(0)}'<#if item_index lt page.showCount-1>,</#if></#list>]
		        },
		        {
		            name:'7日留存数',
		            type:'line',
		            ...
		            data:[<#list page.items?reverse as item>'${item.days7Login?default(0)}'<#if item_index lt page.showCount-1>,</#if></#list>]
		        },
		        {
		            name:'15日留存数',
		            type:'line',
		            ...
		            data:[<#list page.items?reverse as item>'${item.days15Login?default(0)}'<#if item_index lt page.showCount-1>,</#if></#list>]
		        },
		        {
		            name:'30日留存数',
		            type:'line',
		            ...
		            data:[<#list page.items?reverse as item>'${item.days30Login?default(0)}'<#if item_index lt page.showCount-1>,</#if></#list>]
		        }
		    ]
</@dcChart>
