...
<form name="defaultForm" action="${siteUrl}/datacenter/carrierStatistics" method="post" >
...
<div class="widget-content autoHeader">
	<table class="table table-striped table-bordered table-hover" style="min-width:580px;">
...
<script type="text/javascript">
	function commitTable(){
		document.defaultForm.action="${siteUrl}/datacenter/carrierStatistics"; 
		defaultForm.submit();
	}
	function exportExcel(){
		document.defaultForm.action="${siteUrl}/datacenter/makeOtCarriersStatisticsExcel"; 
		defaultForm.submit();
	}
</script>